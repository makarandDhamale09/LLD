 ...
 * <p>
 * Question : Implement 'Notify me' that we see in the Products on Amazon that are out of stock. 
 * Once the product comes in stock we need to send the notification to all the customers who had 
 * clicked on notify me. 
 * <p></p>
 * <B><I>Implementation : </I></B> To implement this we have two objects one is 'Observable' and the
 * other is Observer. When the state of Observable changes it updates the Observer
 * 
 */
public class Main {
